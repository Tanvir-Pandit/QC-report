...
def extract_data_from_pdf(pdf_path, intBusinessUnitId, unique_elements):
    ...
    cleaned_text = extracted_text.replace("<x> ", "")
    cleaned_text = cleaned_text.replace("<", "")
    cleaned_text = cleaned_text.replace("Meas. ", "")
...
if __name__ == '__main__':
    ...
    google_folder_link = "https://drive.google.com/drive/folders/1kPCr69I2DFKcxJ2-CTWnMEQrGn8TtPXF?usp=drive_link"

    gdown.download_folder(google_folder_link)
    print("Folder downloaded")

    folder_path = './Bath Sample'
